...
$lang['To verify you are a human, please place the <b>%s</b> in the most right box bellow.'] = 'Pour vérifier que vous êtes un humain, veuillez placer le <b>%s</b> dans le cadre de droite.';
$lang['You are player X, click on the right case to complete the line.'] = 'Vous êtes le joueur X, cliquez dans la bonne case pour former une ligne complète.';
